...
const AllRetailsOrdersComponent = () => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/SeeAllRetailsOrders/?page=${current_page}&page_size=2`;
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
...
onPress={() => navigation.navigate('Retails Orders Detail Screen', item)} 
          ...
          <View style={globalstyles.ModalView}>
            ...
            <View style={globalstyles.form}>
               ...
               <View style={globalstyles.ButtonConatiner}>
                    ...
                    onPress={() => navigation.navigate('All Retails Closed Orders')} >
...
export default AllRetailsOrdersComponent;
