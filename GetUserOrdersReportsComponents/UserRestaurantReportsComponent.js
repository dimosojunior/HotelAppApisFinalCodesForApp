...
const UserRestaurantReportsComponent = ({id,CategoryId, username}) => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/RestaurantOrder/?CategoryId=${CategoryId}&page=${current_page}&page_size=2`;
...
export default UserRestaurantReportsComponent;
