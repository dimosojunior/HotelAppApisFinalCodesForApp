...
const UserHotelReportsComponent = ({id,CategoryId, username}) => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/HotelOrder/?CategoryId=${CategoryId}&page=${current_page}&page_size=2`;
...
export default UserHotelReportsComponent;
