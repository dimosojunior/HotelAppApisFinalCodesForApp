...
const UserRetailsReportsComponent = ({id,CategoryId, username}) => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/RetailsOrder/?CategoryId=${CategoryId}&page=${current_page}&page_size=2`;
...
export default UserRetailsReportsComponent;
