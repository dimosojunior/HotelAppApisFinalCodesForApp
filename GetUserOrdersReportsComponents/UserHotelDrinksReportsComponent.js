...
const UserHotelDrinksReportsComponent = ({id, username}) => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/HotelDrinksOrder/?page=${current_page}&page_size=2`;
...
export default UserHotelDrinksReportsComponent;
