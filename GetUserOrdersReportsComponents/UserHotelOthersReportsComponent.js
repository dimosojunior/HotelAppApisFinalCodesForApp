...
const UserHotelOthersReportsComponent = ({id, username}) => {
...
const getProducts = () => {
  if (endReached) {
    ...
    setIsLoading(true);
    const url = EndPoint + `/Cart/HotelOthersOrder/?page=${current_page}&page_size=2`;
...
<Text style={[{
 ...
 {setLoading===true?(<ActivityIndicator/>):(
  ...
  <Text style={globalstyles.NoProductText}>No any Drink report
...
export default UserHotelOthersReportsComponent;
