...
const HotelReportsHomeScreenComponent =({inventory}) => {
  ...
  const renderItem = ({item, index}) => {
    ...
    return (
       ...
       activeOpacity={1}
        ...
        // onPress = {() => navigation.replace('Hotel Waiters', item)}
         ...
         onPress={() => {
          ...
          if (item.Category === 'Rooms') {
            ...
            navigation.navigate('Hotel Waiters', item);
          }
        }}
...
export default HotelReportsHomeScreenComponent;
