...
const HotelInventoryHomeScreenComponent =({inventory}) => {
  ...
  const renderItem = ({item, index}) => {
    ...
    return (
       ...
       activeOpacity={1}
         ...
         //onPress = {() => navigation.navigate('Hotel Inventory Products Categories', item)}
          ...
          if (item.Category === 'Rooms') {
            ...
            navigation.navigate('Hotel Inventory Products Categories', item);
          }
        }}
...
export default HotelInventoryHomeScreenComponent;
