...
const HotelNewSaleHomeScreenComponent =({inventory}) => {
...
const [Category, setCategory] = useState('');
    const move = (Category) =>{
      ...
      navigation.navigate('Hotel NewSale ' +Category);
    }
  ...
  const renderItem = ({item, index}) => {
    ...
    return (
       ...
       activeOpacity={1}
         ...
         //onPress = {() => navigation.navigate('Hotel NewSale Products Categories', item)}
         onPress={() => {
          
          if (item.Category === 'Rooms') {
            navigation.navigate('Hotel NewSale Rooms');
          } else {
            navigation.navigate('Hotel NewSale Products Categories', item);
          }
        }}
         >
...
export default HotelNewSaleHomeScreenComponent;
