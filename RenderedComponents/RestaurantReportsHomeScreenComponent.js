...
const RestaurantReportsHomeScreenComponent =({inventory}) => {
  ...
  const renderItem = ({item, index}) => {
    ...
    return (
       ...
       activeOpacity={1}
         ...
         onPress = {() => navigation.replace('Restaurant Waiters', item)}
         >
...
export default RestaurantReportsHomeScreenComponent;
