...
const RestaurantInventoryHomeScreenComponent =({inventory}) => {
...
const [Category, setCategory] = useState('');
    const move = (Category) =>{
      ...
      navigation.navigate('Restaurant Inventory ' +Category);
    }
    ...
    return (
      ...
      style={globalstyles.listContainer}
       activeOpacity={1}
         ...
         onPress = {() => navigation.navigate('Restaurant Inventory Products Categories', item)}
         >
...
export default RestaurantInventoryHomeScreenComponent;
