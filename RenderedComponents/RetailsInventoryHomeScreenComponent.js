...
const RetailsInventoryHomeScreenComponent =({inventory}) => {
...
const [Category, setCategory] = useState('');
    const move = (Category) =>{
      ...
      navigation.navigate('Retails Inventory ' +Category);
    }
    ...
    return (
     ...
     style={globalstyles.listContainer}
       activeOpacity={1}
         ...
         onPress = {() => navigation.navigate('Retails Inventory Products Categories', item)}
         >
...
export default RetailsInventoryHomeScreenComponent;
