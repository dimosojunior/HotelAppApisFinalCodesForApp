...
import AllHotelOrdersComponent from '../AllOrdersComponents/AllHotelOrdersComponent';
import SwitchSelector from 'react-native-switch-selector';
import AllHotelGuestOrdersComponent from '../AllOrdersComponents/AllHotelGuestOrdersComponent';

export default function AllHotelOrders() {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Orders" pressMe={AddReport} screenName="Home Stack" />
