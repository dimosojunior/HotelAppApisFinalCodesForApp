...
import AllRetailsOrdersComponent from '../AllOrdersComponents/AllRetailsOrdersComponent';
import AllRetailsClosedOrdersComponent from '../AllOrdersComponents/AllRetailsClosedOrdersComponent';
import SwitchSelector from 'react-native-switch-selector';

export default function AllRetailsOrders() {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Orders" pressMe={AddReport} screenName="Retailss Category" />
 ...
 <View style={globalstyles.swapButtonsContainer}>
  ...
  <View style={globalstyles.customSwitchContainer}>
   ...
   options={[
      ...
      { label: "Check Closed Bills", value: true },
    ]}
...
<AllRetailsClosedOrdersComponent />
