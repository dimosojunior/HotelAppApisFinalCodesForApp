...
import HotelReportsHomeScreenComponent from '../RenderedComponents/HotelReportsHomeScreenComponent';
...
export default function HotelReportsHomeScreen() {
...
<MinorHeader title="Walking Customers Reports" screenName="Hotel Reports Customer Categories" />
...
{inventory && inventory.length > 0 ? (
  ...
  <HotelReportsHomeScreenComponent inventory={inventory} />
