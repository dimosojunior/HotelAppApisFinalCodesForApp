...
import HotelGuestReportsHomeScreenComponent from '../RenderedComponents/HotelGuestReportsHomeScreenComponent';
...
export default function HotelGuestReportsHomeScreen() {
...
<MinorHeader title="Guest Customers Reports" screenName="Hotel Reports Customer Categories" />
...
{inventory && inventory.length > 0 ? (
  ...
  <HotelGuestReportsHomeScreenComponent inventory={inventory} />
