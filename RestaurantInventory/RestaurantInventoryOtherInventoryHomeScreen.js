...
const RestaurantInventoryOtherInventoryHomeScreen =({navigation }) => {
 ...
 // const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:productsUnit,setDatas:setProductsUnit, isPending, error } = useFetch(EndPoint+'/PostData/PostRestaurantProductsUnit/');
...
<MinorHeader title="Units" pressMe={AddOther} screenName="Restaurant Inventory"/>
...
export default RestaurantInventoryOtherInventoryHomeScreen;
