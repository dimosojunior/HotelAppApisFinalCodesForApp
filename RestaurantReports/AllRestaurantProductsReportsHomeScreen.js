...
import UserRestaurantReportsComponent from '../GetUserOrdersReportsComponents/UserRestaurantReportsComponent';


export default function AllRestaurantProductsReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Restaurant Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserRestaurantReportsComponent username={username} id={id} CategoryId={CategoryId} />)

      : (<RestaurantReportsComponent username={username} id={id} CategoryId={CategoryId} /> )}
