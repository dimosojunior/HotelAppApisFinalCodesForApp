...
const InventoryHotelProducts =({route ,navigation }) => {
...
const Add =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelOtherProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={Add} screenName="Hotel Inventory " />
...
export default InventoryHotelProducts;
