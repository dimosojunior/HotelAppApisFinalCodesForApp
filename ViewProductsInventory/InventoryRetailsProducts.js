...
const InventoryRetailsProducts =({route ,navigation }) => {
...
const Add =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsOtherProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={Add} screenName="Retails Inventory " />
...
export default InventoryRetailsProducts;
