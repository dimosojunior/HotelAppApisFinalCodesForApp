...
const ViewHotelGuestOrders = ({route ,navigation }) => {
...
const [isRange, setisRange] = useState(false);
  ...
  useEffect(() => {
    ...
    axios.get(`${EndPoint}/Cart/GetHotelGuestOrderItems/?id=${id}`)
...
const removeOrderItem = (cartId) => {
   ...
   navigation.replace('Hotel Guest Reports');
...
//   navigation.replace(' Hotel Waiters');
//   setModalVisibleProcessOrder(false);
...
export default ViewHotelGuestOrders;
