...
const RetailsInventoryOtherInventoryHomeScreen =({navigation }) => {
 ...
 // const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:productsUnit,setDatas:setProductsUnit, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsProductsUnit/');
...
<MinorHeader title="Units" pressMe={AddOther} screenName="Retails Inventory"/>
...
export default RetailsInventoryOtherInventoryHomeScreen;
