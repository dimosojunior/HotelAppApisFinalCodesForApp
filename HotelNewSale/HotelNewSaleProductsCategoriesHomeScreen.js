...
const HotelNewSaleProductsCategoriesHomeScreen =({route, navigation }) => {
...
<MinorHeader title={Category} pressMe={AddFood} screenName="Hotel NewSale" />
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Hotel Products', item)}
            >
...
export default HotelNewSaleProductsCategoriesHomeScreen;
