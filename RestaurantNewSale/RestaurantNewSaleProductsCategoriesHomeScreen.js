...
const RestaurantNewSaleProductsCategoriesHomeScreen =({route, navigation }) => {
...
<MinorHeader title={Category} pressMe={AddFood} screenName="Restaurant NewSale" />
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Restaurant Products', item)}
            >
...
export default RestaurantNewSaleProductsCategoriesHomeScreen;
