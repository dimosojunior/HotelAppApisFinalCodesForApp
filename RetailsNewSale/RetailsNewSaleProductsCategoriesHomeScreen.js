...
const RetailsNewSaleProductsCategoriesHomeScreen =({route, navigation }) => {
...
<MinorHeader title={Category} pressMe={AddFood} screenName="Retails NewSale" />
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Retails Products', item)}
            >
...
export default RetailsNewSaleProductsCategoriesHomeScreen;
